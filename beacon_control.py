    ...
    def Go_To_Tags(self,data):
        ...
        while not rospy.is_shutdown():
            try:
                ...
                self.transformation_listener.waitForTransform('/usb_cam1','/beacon',now,rospy.Duration(4.0))
                (transition_beacon,rotation_beacon) = self.transformation_listener.lookupTransform('/usb_cam1',bundle_no,now)
                transition = transition_beacon
                rotation = rotation_beacon
                ...
                #delete pose z 
                    ...
                    while True:
                        if self.pose_z_range-n >0.5:
                            ...
                            break
                #change altitude
                if self.pose_z_range <=0.55 and bundle_no == '/beacon':
                    #print('return true')
